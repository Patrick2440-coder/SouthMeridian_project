    ...
    <div class="card-body pb-0">
      <div class="d-flex align-items-start">
        <div>
          ...
          <p class="card-subtitle">Homeowners Association Overview</p>
        </div>
        <div class="ms-auto">
          <div class="dropdown">
            <a href="javascript:void(0)" class="text-muted" id="hoa-weekly-dropdown" data-bs-toggle="dropdown"
              aria-expanded="false">
      ...
      <div class="mt-4 pb-3 d-flex align-items-center">
        ...
        <div class="ms-3">
          <h5 class="mb-0 fw-bolder fs-4">Dues Collected</h5>
          <span class="text-muted fs-3">This Week</span>
        </div>
        <div class="ms-auto">
      ...
      <div class="py-3 d-flex align-items-center">
        ...
        <div class="ms-3">
          <h5 class="mb-0 fw-bolder fs-4">Active Homeowners</h5>
          <span class="text-muted fs-3">Registered Residents</span>
        </div>
        <div class="ms-auto">
          <span class="badge bg-secondary-subtle text-muted">95%</span>
        </div>
      </div>
      ...
      <div class="py-3 d-flex align-items-center">
        ...
        <div class="ms-3">
          <h5 class="mb-0 fw-bolder fs-4">Maintenance Requests</h5>
          <span class="text-muted fs-3">Resolved This Week</span>
        </div>
        <div class="ms-auto">
      ...
      <div class="pt-3 mb-7 d-flex align-items-center">
        ...
        <div class="ms-3">
          <h5 class="mb-0 fw-bolder fs-4">Community Concerns</h5>
          <span class="text-muted fs-3">New Reports</span>
        </div>
        <div class="ms-auto">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <div class="d-md-flex align-items-center">
                    <div>
                      <h4 class="card-title">Home Owners</h4>
                    ...
                    <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                      <thead>
                        <tr>
                          ...
                          <th scope="col" class="px-0 text-muted">Reason</th>
                          <th scope="col" class="px-0 text-muted">
                            Status
                          </th>
